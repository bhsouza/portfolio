...
export const gridItems = [
  {
    id: 1,
    title:
      "Priorizo uma colaboração com o cliente, em busca de entregar o melhor produto",
    description: "",
  ...
  },
  {
    id: 2,
    title:
      "Inglês intermediário, em busca de fluência para aprimorar a comunicação profissional",
    description: "",
  ...
  {
    id: 3,
    title: "Nas tecnologias recentes",
    description: "Atualização contínua",
    className: "lg:col-span-2 md:col-span-3 md:row-span-2",
    imgClassName: "",
...
export const projects = [
  ...
  {
    id: 2,
    title: "YC Directory - Apresente sua Startup",
    des: "Envie ideias, vote em propostas e seja notado em competições virtuais.",
    img: "/p2.svg",
    iconLists: [
      "/next.svg",
      "/sanity.svg",
  ...
  {
    id: 4,
    title: "Animais Fantásticos - Site",
