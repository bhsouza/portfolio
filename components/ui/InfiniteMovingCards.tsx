  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="relative w-[90vw] max-w-full shrink-0 rounded-2xl border border-b-0 border-slate-800 bg-[rgb(4,7,29)] bg-[linear-gradient(90deg, rgba(4,7,29,1) 0%, rgba(12,14,35,1) 100%)] p-5 md:p-16 md:w-[60vw]"
            key={idx}
          >
            <blockquote>
              <div
              ...
              <div className="relative z-20 mt-6 flex flex-row items-center">
                <div className="flex gap-1 items-center">
                  <div className="me-3">
                    <img src="/profile.svg" alt="profilePhoto" />
                  </div>
